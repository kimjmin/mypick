...
<nav class="navbar navbar-inverse" role="navigation">
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#">myPick 회원 가입</a>
	</div>
</nav>
				
		<div class="container">
		<form class="form-inline" role="form" name="signinFrm" action="javascript:signin();">
		...
		$("#birthD").append("<option value='30'>30</option>");
			...
			<div class="row">
				<div class="container">
					...
					<div class="col-md-2">
						<a type="button" class="btn btn-danger btn-block" href="index.jsp">취소</a>
					</div>
