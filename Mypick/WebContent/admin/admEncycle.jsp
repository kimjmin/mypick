...
<div class="col-md-12">
	<ul id="fldFmtTab" class="nav nav-tabs">
		...
		<li <%if("fileUp".equals(enclTab)){out.print("class='active'");} %> ><a href="#fileUp" data-toggle="tab">파일 업로드</a></li>
	</ul>
...
<!-- 내용 입력 탭 끝 -->
<!-- 파일 업로드 탭 시작 -->
<div class="tab-pane fade <%if("fileUp".equals(enclTab)){out.print("active");} %> in" id="fileUp">
	<h3>파일 업로드</h3>
        ...
        <td>
            <span class="preview">
                {% if (file.thumbnailUrl) { %}
                    <a href="{%=file.url%}" title="{%=file.name%}" target="_new"><img src="{%=file.thumbnailUrl%}"></a>
                {% } %}
            </span>
        </td>
        <td>
...
<script src="<%=MpickParam.getHostUrl()%>/js/blueimp/tmpl.min.js"></script>
<!-- The Load Image plugin is included for the preview images and image resizing functionality -->
<script src="<%=MpickParam.getHostUrl()%>/js/blueimp/load-image.all.min.js"></script>
<!-- The Canvas to Blob plugin is included for image resizing functionality -->
<script src="<%=MpickParam.getHostUrl()%>/js/blueimp/canvas-to-blob.min.js"></script>
<!-- blueimp Gallery script -->
<script src="<%=MpickParam.getHostUrl()%>/js/blueimp/jquery.blueimp-gallery.min.js"></script>
